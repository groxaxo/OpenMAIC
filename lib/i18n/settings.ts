export const settingsZhCN = {
  settings: {
    ...
    providerInworldTTS: 'Inworld TTS',
    ...
    inworldVoiceSearch: '搜索 Inworld 音色',
    inworldSourceFilter: '音色来源',
    allSources: '全部来源',
    inworldTagsFilter: '标签筛选',
    allTags: '全部标签',
    loadingVoices: '正在加载音色...',
    noVoicesAvailable: '当前没有可用音色',
    noVoicesMatchFilter: '没有符合筛选条件的音色',
...
export const settingsEnUS = {
  settings: {
    ...
    inworldVoiceSearch: 'Search Inworld voices',
    inworldSourceFilter: 'Voice Source',
    allSources: 'All Sources',
    inworldTagsFilter: 'Tag Filter',
    allTags: 'All Tags',
    loadingVoices: 'Loading voices...',
    noVoicesAvailable: 'No voices available',
    noVoicesMatchFilter: 'No voices match the current filters',
...
export const settingsEsES = {
  settings: {
    ...
    theme: 'Tema',
    themeDesc: 'Selecciona el modo de tema (claro/oscuro/sistema)',
    themeOptions: {
      light: 'Claro',
      dark: 'Oscuro',
      system: 'Sistema',
    ...
    testConnectionDesc: 'Comprueba si la configuración actual de la API está disponible',
    testing: 'Probando...',
    agentSettings: 'Configuración de agentes',
    agentSettingsDesc:
      'Selecciona los agentes que participarán en la conversación. Elige 1 para modo de agente único o varios para colaboración multiagente.',
    agentMode: 'Modo de agente',
    agentModePreset: 'Predefinido',
    agentModeAuto: 'Generación automática',
    agentModeAutoDesc: 'La IA generará automáticamente los roles adecuados',
    autoAgentCount: 'Cantidad de agentes',
    autoAgentCountDesc: 'Número de agentes a generar automáticamente (incluyendo al profesor)',
    ...
    addProviderDescription:
      'Añade proveedores de modelos personalizados para ampliar los modelos disponibles',
    providerNames: {
      ...settingsEnUS.settings.providerNames,
      qwen: 'Qwen',
      opencode: 'OpenCode',
    },
    providerTypes: {
    ...
    providerName: 'Nombre',
    providerNamePlaceholder: 'p. ej., mi proxy OpenAI',
    providerNameRequired: 'Introduce el nombre del proveedor',
    ...
    providerIcon: 'URL del icono del proveedor',
    ...
    resetSuccess: 'Restablecido correctamente a la configuración predeterminada',
    saveSuccess: 'Ajustes guardados',
    saveFailed: 'No se pudieron guardar los ajustes; inténtalo de nuevo',
    noModelsAvailable: 'No hay modelos disponibles para la prueba',
    ...
    addNewModel: 'Modelo nuevo',
    addNewModelDescription: 'Añade una nueva configuración de modelo',
